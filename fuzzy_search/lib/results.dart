                              ...
                              children: [
                                  ...
                                  child: SingleChildScrollView(
                                    child: Column(
                                      children: [
                                        ...
                                        for (CodeScoreTile scoreTile
                                            in mainData.codeScoreTiles)
                                          GestureDetector(
                                            child: scoreTile,
                                            onDoubleTap: () {
                                              setState(() {
                                                print(scoreTile.score);
                                                mainData.changeScore(
                                                    scoreTile.score);
                                                dnaTextWidgets = mainData
                                                    .getDnaTextWidgets();
                                                Data.itemScrollController.scrollTo(index: 1, duration: Duration(seconds: 1));
                                              });
                                            },
                                          )
                                      ],
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Graph(
                                      resultGraphData: mainData.graphData,
                                    ),
                                  )),
                                )
                              ],
